...
SFR(PERCFG,   0xF1); // Peripheral I/O Control
   SBIT(PERCFG_U0CFG,  0xF1, 0); //  USART 0 I/O location 0:Alternative 1 location 1:Alternative 2 location
   SBIT(PERCFG_U1CFG,  0xF1, 1); //  USART 1 I/O location 0:Alternative 1 location 1:Alternative 2 location
